...
<div class="card">
    ...
    <div class="card-header">
        <!--begin::Card title-->
        <div class="card-title fs-3 fw-bold">Sampaikan Pengaduan</div>
        <!--end::Card title-->
    </div>
    <!--end::Card header-->
    <!--begin::Form-->
    <form id="kt_project_settings_form" class="form">
        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-8">
                    <!--begin::Image input-->
                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('<?= base_url() ?>media/svg/avatars/blank.svg')">
                        <!--begin::Preview existing avatar-->
                        <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image: url('<?= base_url() ?>media/svg/brand-logos/volicity-9.svg')"></div>
