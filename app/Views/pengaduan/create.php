...
<form enctype="multipart/form-data" method="post" action="<?= base_url('pengaduan/create') ?>">
    ...
    <div class="row mb-8">
        <!--begin::Col-->
        <div class="col-xl-3">
            <div class="fs-6 fw-semibold mt-2 mb-3">Foto 1</div>
        </div>
        <!--end::Col-->
        <!--begin::Col-->
        <div class="col-xl-9 fv-row">
            <input type="file" class="form-control form-control-solid <?= session('errors.foto1') ? 'is-invalid' : '' ?>" name="foto1" accept=".png, .jpg, .jpeg"/>

            <div class="fv-plugins-message-container invalid-feedback">
                <?= session('errors.foto1') ?>
            </div>
        </div>
    </div>
    <!--end::Row-->
    ...
    <div class="row mb-8">
        <!--begin::Col-->
        <div class="col-xl-3">
            <div class="fs-6 fw-semibold mt-2 mb-3">Foto 2</div>
        </div>
        <!--end::Col-->
        <!--begin::Col-->
        <div class="col-xl-9 fv-row">
            <input type="file" class="form-control form-control-solid <?= session('errors.foto2') ? 'is-invalid' : '' ?>" name="foto2" accept=".png, .jpg, .jpeg"/>

            <div class="fv-plugins-message-container invalid-feedback">
                <?= session('errors.foto2') ?>
            </div>
        </div>
    </div>
    <!--end::Row-->
    ...
    <div class="row mb-8">
        <!--begin::Col-->
        <div class="col-xl-3">
            <div class="fs-6 fw-semibold mt-2 mb-3">Foto 3</div>
        </div>
        <!--end::Col-->
        <!--begin::Col-->
        <div class="col-xl-9 fv-row">
            <input type="file" class="form-control form-control-solid <?= session('errors.foto3') ? 'is-invalid' : '' ?>" name="foto3" accept=".png, .jpg, .jpeg"/>

            <div class="fv-plugins-message-container invalid-feedback">
                <?= session('errors.foto3') ?>
            </div>
        </div>
    </div>
    <!--end::Row-->
