...
<a href="<?= base_url('pengaduan-masuk') ?>" class="btn btn-light-danger mb-10 me-3">
    <i class="ki-outline ki-to-left fs-2"></i>Kembali
</a>

<?php if (hasActionAccess('write', user_id()) && in_groups(['1', '2'])): ?>
    <button type="button" class="btn btn-light-primary mb-10 me-3" data-bs-toggle="modal"
            data-bs-target="#kt_modal_assign_pengaduan">
        <i class="ki-outline ki-arrow-mix fs-2"></i>Alih Tugas
    </button>
<?php endif; ?>

<button type="button" class="btn btn-light-success mb-10 me-3" data-bs-toggle="modal"
...
<div class="row mb-3">
    ...
    <div class="col-9">
        <span
            class="fs-6 badge badge-light-<?= COLOR[$pengaduan['wilayah_id'] % count(COLOR)] ?> fw-bolder"><?= $pengaduan['nama_wilayah'] ?></span>
    </div>
</div>
<!--end::Row-->
...
<div class="row mb-8">
    <!--begin::Col-->
    <div class="col-xl-3">
        <div class="fs-6 mt-2 mb-3">Foto</div>
    </div>
    <!--end::Col-->
    <!--        preview foto-->
...
<div class="row mb-8">
    <!--begin::Col-->
    <div class="col-xl-3">
        <div class="fs-6 mb-3">Deskripsi</div>
    </div>
    <!--end::Col-->
    <!--begin::Col-->
    <div class="col-xl-9 fv-row">
        <textarea type="text" class="form-control form-control-solid" rows="3"
                  disabled><?= $pengaduan['deskripsi'] ?></textarea>
    </div>
</div>
<!--end::Row-->
...
<div class="row mb-8">
    <!--begin::Col-->
    <div class="col-xl-3">
        <div class="fs-6 mt-2 mb-3">Tanggapan</div>
    </div>
    <!--end::Col-->
    <!--begin::Col-->
    <div class="col-xl-9 fv-row">
        <textarea type="text" class="form-control form-control-solid" rows="3"
                  disabled><?= $pengaduan['komentar'] ?></textarea>
    </div>
</div>
<!--end::Row-->
...
<div class="modal fade" id="kt_modal_assign_pengaduan" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--end::Notice-->
                <!--begin::Form-->
                <form id="kt_modal_assign_pengaduan" action="<?= base_url('pengaduan-masuk/update') ?>" method="post">
                    <input type="hidden" name="kode" value="<?= $pengaduan['kode'] ?>">
                    <input type="hidden" name="status_id" value="<?= $pengaduan['status_id'] ?>">
                    <!--begin::Input group-->
                    <div class="fv-row mb-7">
                        ...
                        <select class="form-select form-select-solid" data-control="select2"
                                ...
                                name="wilayah_id"
                                data-dropdown-parent="#kt_modal_assign_pengaduan"
                                data-allow-clear="true">
                            <option></option>
                            <?php foreach ($wilayah as $w) : ?>
                                <option
                                    value="<?= $w['id'] ?>" <?= $pengaduan['wilayah_id'] == $w['id'] ? 'selected' : '' ?>><?= $w['nama_wilayah'] ?></option>
                            <?php endforeach; ?>
                        </select>
                        <!--end::Input-->
                    </div>
                    ...
                    <div class="fv-row mb-7">
                        <div class="fv-row mb-7">
                            ...
                            <textarea class="form-control form-control-solid" rows="3" name="komentar"
                                      placeholder="Tanggapan"><?= $pengaduan['komentar'] ?></textarea>
                            <!--end::Input-->
                        </div>
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <select class="form-select form-select-solid" data-control="select2"
                            ...
                            <?php foreach ($status as $s) : ?>
                                <option
                                    value="<?= $s['id'] ?>" <?= $pengaduan['status_id'] == $s['id'] ? 'selected' : '' ?>><?= $s['label'] . ' | ' . $s['deskripsi'] ?></option>
                            <?php endforeach; ?>
                        </select>
                        <!--end::Input-->
                    </div>
