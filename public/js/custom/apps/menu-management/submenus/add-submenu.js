...
var KTUsersAddSubMenu = function () {
    const t = document.getElementById("kt_modal_add_submenu"), e = t.querySelector("#kt_modal_add_submenu_form"),
                        ...
                        if ("Valid" === t) {
                            ...
                            setTimeout(function () {
                                ...
                                const data = {
                                    ...
                                    menu_id: e.querySelector('#menu_id').value,
                                    permission_id: e.querySelector('#permission_id').value,
